...
llm = ChatGroq(model="groq/qwen-qwq-32b", api_key=groq_api_key)
...
def create_inquiry_task(agent, question):
    ...
    return Task(
        description=f"Answer this customer inquiry professionally and accurately: {question} only answer on what",
        agent=agent,
